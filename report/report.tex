...
The implementation for this this project will be derived from a rudimentary implementation of a roomba robot \cite{Simulation_for_Roomba}. This implementation \cite{Simulation_for_Roomba} chooses its next tile based on a random selection from a 360$^{\circ}$ scale. We have instead opted to use the octet based selection as shown on figure 1 to choose the next tile. 
